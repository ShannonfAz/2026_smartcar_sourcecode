...
public:
    ...
    unsigned short* returnscreenbase();
    //-------------------------------------------------------------------------------------------------------------------
    // 函数简介     清屏函数
    // 参数说明     void
    // 返回参数     void
    ...
    // 备注信息     在指定两点之间绘制一条直线
    //-------------------------------------------------------------------------------------------------------------------
    void draw_line(int16 x_start, int16 y_start, int16 x_end, int16 y_end, const uint16 color);
    ...
    {
        this->show_rgb565_image(0, 0, p, 240, 180, width, height, 0);
    }
